...
- GitHub Actions workflow `.github/workflows/refresh-data.yml` refreshes on a ~30-minute cron (and workflow_dispatch), commits data, and deploys Pages — no API secrets required.
