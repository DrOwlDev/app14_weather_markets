...
- GitHub Actions workflow `.github/workflows/refresh-data.yml` refreshes on a ~5-minute cron (GitHub minimum) and workflow_dispatch, commits data, and deploys Pages. Site “Refresh data” queues dispatch via a browser-local PAT.
